...
@Mod("exacraft")
public class ExacraftMod {
	public static final Logger LOGGER = LogManager.getLogger(ExacraftMod.class);
	public static final String MODID = "exacraft";
